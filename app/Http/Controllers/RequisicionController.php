...
class RequisicionController extends Controller
{
    ...
    public function show($id){
        $acta = Acta::with(['requisiciones'=>function($query){ $query->orderBy('requisiciones.tipo_requisicion'); },'requisiciones.insumos','requisiciones.insumosClues','unidadMedica','empresa'])->find($id);
