...
class ActualizarTablaActasAgregarCamposPorcentaje extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('actas', function (Blueprint $table) {
            if(Schema::hasColumn('actas', 'firma_solicita')){
                $table->dropColumn('firma_solicita');
                $table->dropColumn('cargo_solicita');
            }
